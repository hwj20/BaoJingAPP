package com.example.baojing.gpstools;
...
public class LongClickView extends View {
    public int DEFAULT_MAX_SECONDS = 2;
    public int DEFAULT_ANNULUS_WIDTH = 50;
    ...
    private void getAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        //annulusColor 圆环的颜色
        DEFAULT_ANNULUS_COLOR = context.getResources().getColor(R.color.paleturquoise);
    ...
    private void initView() {
        ...
        mMiddenCirclePaint.setColor(Color.YELLOW);
...
//        mAngleCirclePaint.setColor(mAnnulusColor);
        mAngleCirclePaint.setColor(Color.RED);
